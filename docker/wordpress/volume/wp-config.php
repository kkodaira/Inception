...
/** MySQL database kkodairaname */
define( 'DB_USER', 'kkodaira' );
 ...
 * You can change these at any point in time to invalidate all existing cookies. This will force all kkodairas to have to log in again.
 *
 * @since 2.6.0
 */
